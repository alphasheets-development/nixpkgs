...
stdenv.mkDerivation rec {
  ...
  propagatedNativeBuildInputs = [ alex.bin happy.bin ];
  buildInputs =
   let haskellPkgs = [ alex.bin happy.bin bootPkgs.hscolour.bin bootPkgs.cabal-install bootPkgs.haddock bootPkgs.hpc
    ]; in [ bootPkgs.ghc
